...
import { JDLParser } from './jdlParser';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    let previewUri = vscode.Uri.parse('jdl-preview://jdl-preview');
    let jdlParser = new JDLParser();
    class TextDocumentContentProvider implements vscode.TextDocumentContentProvider {
        ...
        public provideTextDocumentContent(uri: vscode.Uri): string {
            ...
            if (!(editor.document.languageId === 'jdl')) {
            ...
            let parsedText = jdlParser.parse(text);
            return this.generateDiagram( parsedText );
        }
    ...
    let registration = vscode.workspace.registerTextDocumentContentProvider('jdl-preview', provider);
    ...
    let disposable = vscode.commands.registerCommand('extension.jdlStudio', () => {
